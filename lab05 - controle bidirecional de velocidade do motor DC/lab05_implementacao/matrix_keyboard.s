...
Espera_Porta  
	...
	LDR R0, =GPIO_PORTL_PUR_R	;Carrega o endere�o do PUR
	LDR R1, [R0]
...
;--------------------------------------------------------------------------------
; Funcao MKBOARD_getCharPressed
; Parametro de entrada: Nao tem
; Parametro de saida: R0
; nenhuma tecla pressionada: -1
MKBOARD_getCharPressed
...
set_column
	...
	MOV R0, #'-'
	B return_MKBOARD_getCharPressed
...
select_value
	...
	ITT EQ
		MOVEQ R0, #'1'
		BEQ return_MKBOARD_getCharPressed
